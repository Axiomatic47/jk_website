...
export interface CV {
  ...
  location: string;
  email: string;
  pdf: string;           // styled CV PDF: /resume/… owner-exported from Word (tracked) or /cv/… generated at build
  pdf_print: string;     // print-friendly CV PDF (no shading), same two forms; or ""
